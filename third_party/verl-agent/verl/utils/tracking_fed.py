...
class Tracking:
    ...
    supported_backend = ["wandb", "mlflow", "swanlab", "vemlp_wandb", "tensorboard", "console", "clearml", "json"]
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = "console", config=None):
        ...
        if "json" in default_backend:
            json_log_dir = os.environ.get("JSON_LOG_DIR", "json_logs")
            self.logger["json"] = JSONLogger(json_log_dir)
...
class JSONLogger:
    """Simple JSON logger for saving metrics to a JSON file."""
